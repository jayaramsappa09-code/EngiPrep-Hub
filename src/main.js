            ...
            if (navActions) {
                navActions.innerHTML = `
                    <div class="flex items-center gap-4">
                        ${themeBtnPlaceholder}
                        <a href="/curriculum.html" class="flex items-center gap-3 px-3 py-2 rounded-xl text-xs font-black text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-900/60 transition-colors">
                    <span class="text-base select-none">🎓</span>
                    <span class="flex-1">B.Tech Curriculum</span>
                    <span class="text-[9px] font-mono text-slate-400/90">PLAN</span>
                </a>
