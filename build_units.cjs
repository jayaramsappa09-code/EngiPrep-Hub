    ...
    <main class="max-w-7xl mx-auto px-6 pt-32 pb-40">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div class="lg:col-span-9 space-y-16">
                ...
                <!-- SECTION 10: Laboratory & theoretical concept Viva Questions -->
                <section id="viva" class="glass-card p-8 scroll-mt-24 bg-white dark:bg-slate-900 shadow-sm mt-8">
                    <div class="flex items-center gap-3 mb-6 border-b border-slate-900 pb-3">
                        <span class="text-xl">🧪</span>
                        <h2 class="text-xl font-black text-slate-900 dark:text-slate-50 uppercase tracking-tight">Interactive Laboratory & Concept Viva Cards</h2>
                    </div>
                    <p class="text-xs text-slate-400 mb-6 font-medium">Prepare for your external examiner! Click on any card below to flip and reveal the ideal model answer directly:</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Viva Card 1 -->
                        <div class="relative w-full h-36 cursor-pointer group" onclick="flipVivaCard(this)">
                            <div class="viva-card-inner absolute inset-0 w-full h-full duration-500 border border-slate-800 rounded-2xl bg-slate-950/80" style="transition: transform 0.6s; transform-style: preserve-3d;">
                                <!-- Front -->
                                <div class="viva-card-front absolute inset-0 p-5 flex flex-col justify-between" style="backface-visibility: hidden;">
                                    <span class="text-[8px] font-black uppercase text-blue-500 tracking-wider">Question 01</span>
                                    <h4 class="text-xs font-black text-slate-100 leading-normal pr-4">What is the core principle behind ${unit.concept1.title}?</h4>
                                    <span class="text-[9px] font-bold text-slate-500 self-end">TAP TO FLIP 🔄</span>
                                </div>
                                <!-- Back -->
                                <div class="viva-card-back absolute inset-0 p-5 bg-[#11111e] rounded-2xl flex flex-col justify-between" style="backface-visibility: hidden; transform: rotateY(180deg);">
                                    <span class="text-[8px] font-black uppercase text-emerald-400 tracking-wider">Verified Answer</span>
                                    <p class="text-[10.5px] text-slate-300 leading-relaxed">${unit.concept1.detail}</p>
                                    <span class="text-[8.5px] text-slate-500 self-end">CLICK TO ROTATE</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative w-full h-36 cursor-pointer group" onclick="flipVivaCard(this)">
                            <div class="viva-card-inner absolute inset-0 w-full h-full duration-500 border border-slate-800 rounded-2xl bg-slate-950/80" style="transition: transform 0.6s; transform-style: preserve-3d;">
                                <!-- Front -->
                                <div class="viva-card-front absolute inset-0 p-5 flex flex-col justify-between" style="backface-visibility: hidden;">
                                    <span class="text-[8px] font-black uppercase text-blue-500 tracking-wider">Question 02</span>
                                    <h4 class="text-xs font-black text-slate-100 leading-normal pr-4">Explain the concept of ${unit.concept2.title} briefly.</h4>
                                    <span class="text-[9px] font-bold text-slate-500 self-end">TAP TO FLIP 🔄</span>
                                </div>
                                <!-- Back -->
                                <div class="viva-card-back absolute inset-0 p-5 bg-[#11111e] rounded-2xl flex flex-col justify-between" style="backface-visibility: hidden; transform: rotateY(180deg);">
                                    <span class="text-[8px] font-black uppercase text-emerald-400 tracking-wider">Verified Answer</span>
                                    <p class="text-[10.5px] text-slate-300 leading-relaxed">${unit.concept2.detail}</p>
                                    <span class="text-[8.5px] text-slate-500 self-end">CLICK TO ROTATE</span>
                                </div>
                            </div>
                        </div>
