...
app.use((req, res, next) => {
  ...
  // 1. Redirection for old query parameters (e.g. subject.html?sub=X)
  if (reqPath === '/subject.html' && (req.query.sub || req.query.slug)) {
    const sub = (req.query.sub || req.query.slug || '').toString().toLowerCase();
    let target = '/all-subjects.html';
    if (sub.includes('physics') || sub.includes('ap102')) target = '/engineering-physics';
    else if (sub.includes('chemistry')) target = '/engineering-chemistry';
    else if (sub.includes('mathematics ii') || sub === 'm2' || sub.includes('maths ii') || sub.includes('maths 2')) target = '/engineering-mathematics-2';
    else if (sub.includes('mathematics i') || sub === 'm1' || sub.includes('maths i') || sub.includes('maths 1') || sub.includes('mathematics')) target = '/engineering-mathematics';
    else if (sub.includes('graphics') || sub === 'eg' || sub.includes('engineering graphics')) target = '/engineering-graphics';
    else if (sub.includes('english') || sub.includes('communicative')) target = '/communicative-english';
    else if (sub.includes('electrical') || sub === 'beee' || sub.includes('basic electrical')) target = '/basic-electrical-engineering';
    else if (sub.includes('c programming') || sub.includes('pps') || sub.includes('problem solving')) target = '/c-programming';
    else if (sub.includes('data structure')) target = '/data-structures';
    else if (sub.includes('civil') || sub.includes('mechanical') || sub.includes('bcme')) target = '/basic-civil-and-mechanical-engineering';
    
    return res.redirect(301, target);
  }
  
  // 2. Redirection for old note-viewer.html?subject=X&unit=Y parameters
  if (reqPath === '/note-viewer.html' && (req.query.subject || req.query.sub) && req.query.unit) {
    const subject = (req.query.subject || req.query.sub || '').toString().toLowerCase();
    ...
    else if (subject.includes('mathematics') || subject === 'm1' || subject.includes('maths')) prefix = 'engineering-mathematics';
    ...
    else if (subject.includes('civil') || subject.includes('mechanical') || subject.includes('bcme')) prefix = 'basic-civil-and-mechanical-engineering';
    ...
    if (prefix) {
      return res.redirect(301, `/${prefix}-unit-${unit}`);
    }
  }

  // 3. Redirection for direct .html request paths
  if (reqPath.endsWith('.html')) {
    ...
    if (directMappings[filename]) {
      return res.redirect(301, directMappings[filename]);
    }
    
    if (filename.endsWith('-unit-1.html') || filename.endsWith('-unit-2.html') || filename.endsWith('-unit-3.html') || filename.endsWith('-unit-4.html') || filename.endsWith('-unit-5.html')) {
      let name = filename.replace('.html', '');
      if (name.startsWith('chemistry-unit-')) {
        name = name.replace('chemistry-unit-', 'engineering-chemistry-unit-');
      }
      return res.redirect(301, '/' + name);
    }
  }
...
const canonicalUnitRoutes = [
  // Physics 1-5
  { path: '/engineering-physics-unit-1', file: 'engineering-physics-unit-1.html' },
  { path: '/engineering-physics-unit-2', file: 'engineering-physics-unit-2.html' },
  { path: '/engineering-physics-unit-3', file: 'engineering-physics-unit-3.html' },
  { path: '/engineering-physics-unit-4', file: 'engineering-physics-unit-4.html' },
  { path: '/engineering-physics-unit-5', file: 'engineering-physics-unit-5.html' },
  // Chemistry 1-5
  { path: '/engineering-chemistry-unit-1', file: 'chemistry-unit-1.html' },
  { path: '/engineering-chemistry-unit-2', file: 'chemistry-unit-2.html' },
  { path: '/engineering-chemistry-unit-3', file: 'chemistry-unit-3.html' },
  { path: '/engineering-chemistry-unit-4', file: 'chemistry-unit-4.html' },
  { path: '/engineering-chemistry-unit-5', file: 'chemistry-unit-5.html' },
  // Maths 1-5
  { path: '/engineering-mathematics-unit-1', file: 'engineering-mathematics-unit-1.html' },
  { path: '/engineering-mathematics-unit-2', file: 'engineering-mathematics-unit-2.html' },
  { path: '/engineering-mathematics-unit-3', file: 'engineering-mathematics-unit-3.html' },
  { path: '/engineering-mathematics-unit-4', file: 'engineering-mathematics-unit-4.html' },
  { path: '/engineering-mathematics-unit-5', file: 'engineering-mathematics-unit-5.html' },
  // C Programming 1-5
  ...
  // BEEE 1-5
  { path: '/basic-electrical-engineering-unit-1', file: 'basic-electrical-engineering-unit-1.html' },
  { path: '/basic-electrical-engineering-unit-2', file: 'basic-electrical-engineering-unit-2.html' },
  { path: '/basic-electrical-engineering-unit-3', file: 'basic-electrical-engineering-unit-3.html' },
  { path: '/basic-electrical-engineering-unit-4', file: 'basic-electrical-engineering-unit-4.html' },
  { path: '/basic-electrical-engineering-unit-5', file: 'basic-electrical-engineering-unit-5.html' },
  // BCME 1-5
  { path: '/basic-civil-and-mechanical-engineering-unit-1', file: 'basic-civil-and-mechanical-engineering-unit-1.html' },
  { path: '/basic-civil-and-mechanical-engineering-unit-2', file: 'basic-civil-and-mechanical-engineering-unit-2.html' },
  { path: '/basic-civil-and-mechanical-engineering-unit-3', file: 'basic-civil-and-mechanical-engineering-unit-3.html' },
  { path: '/basic-civil-and-mechanical-engineering-unit-4', file: 'basic-civil-and-mechanical-engineering-unit-4.html' },
  { path: '/basic-civil-and-mechanical-engineering-unit-5', file: 'basic-civil-and-mechanical-engineering-unit-5.html' },
  // Communicative English 1-5
  { path: '/communicative-english-unit-1', file: 'communicative-english-unit-1.html' },
  { path: '/communicative-english-unit-2', file: 'communicative-english-unit-2.html' },
  { path: '/communicative-english-unit-3', file: 'communicative-english-unit-3.html' },
  { path: '/communicative-english-unit-4', file: 'communicative-english-unit-4.html' },
  { path: '/communicative-english-unit-5', file: 'communicative-english-unit-5.html' },
  // Data Structures 1-5
  { path: '/data-structures-unit-1', file: 'data-structures-unit-1.html' },
  { path: '/data-structures-unit-2', file: 'data-structures-unit-2.html' },
  { path: '/data-structures-unit-3', file: 'data-structures-unit-3.html' },
  { path: '/data-structures-unit-4', file: 'data-structures-unit-4.html' },
  { path: '/data-structures-unit-5', file: 'data-structures-unit-5.html' }
];

const canonicalAuxiliaryRoutes = [
...
canonicalUnitRoutes.forEach(route => {
  app.get(route.path, (req, res) => res.sendFile(getFilePath(route.file)));
  app.get(`${route.path}/`, (req, res) => res.sendFile(getFilePath(route.file)));
});

canonicalAuxiliaryRoutes.forEach(route => {
  app.get(route.path, (req, res) => res.sendFile(getFilePath(route.file)));
  app.get(`${route.path}/`, (req, res) => res.sendFile(getFilePath(route.file)));
});
